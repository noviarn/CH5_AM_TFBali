        ...
        Button {
            ...
            VStack(alignment: .leading, spacing: 6) {
                Image(systemName: poi.icon)
                    ...
                    .background(Color.deepPrimaryPurple, in: Circle())
    ...
    private func categoryChip(_ category: String) -> some View {
        ...
        return Button {
            ...
            Text(category)
                .font(.system(.footnote, design: .rounded))
                .fontWeight(.bold)
                .foregroundStyle(isSelected ? .white : Color.deepPrimaryPurple)
                .padding(.horizontal, 14)
                .padding(.vertical, 8)
                .background(
                    isSelected ? Color.deepPrimaryPurple : Color.gray.opacity(0.12),
                    in: Capsule()
                )
        }
        .buttonStyle(.plain)
